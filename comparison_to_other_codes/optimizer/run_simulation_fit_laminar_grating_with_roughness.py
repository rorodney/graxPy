"""Laminar fixed-angle sweep using fitted roughness optimizer parameters."""
...
fit_output_dir = example_root / "results" / "laminar_discrete_fit_with_roughness"
...
if not fitted_parameters_path.exists():
    raise FileNotFoundError(
        ...
        "Run fit_laminar_grating_with_roughness.py first."
    )
